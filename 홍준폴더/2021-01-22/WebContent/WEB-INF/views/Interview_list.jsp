			...
			<tr>
				<td>
					...
					placeholder="검색어를 입력하세요." style="width: 200px;">
					  <button class="btn btn-default" type="button" id="searchSort" data-bs-toggle="dropdown" aria-expanded="false">
  ...
  <path fill-rule="evenodd" d="M11.5 15a.5.5 0 0 0 .5-.5V2.707l3.146 3.147a.5.5 0 0 0 .708-.708l-4-4a.5.5 0 0 0-.708 0l-4 4a.5.5 0 1 0 .708.708L11 2.707V14.5a.5.5 0 0 0 .5.5zm-7-14a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 .708-.708L4 13.293V1.5a.5.5 0 0 1 .5-.5z"/>
		...
		<table id="table2" class="table table-striped table-hover">
			...
			<tr id="detail">
				...
				<td><a href="interview_detail.action?post_code=${interview.post_code}&user_code=${interview.user_code}">${interview.title}</a></td>
				<td>${interview.user_name }</td>
				<td>${interview.write_date }</td>
				<td>${interview.hitcount }</td>
				<td>${interview.rec }</td>
				<td>${interview.notrec }</td>
			</tr>
			</c:forEach>
		</table>
		
		<div id=btnSet>
			<input type="button" value="글쓰기" class="btn btn-primary" id="interviewwrite">
