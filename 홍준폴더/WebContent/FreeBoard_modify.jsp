					...
					<div id="bbsCreated">
							...
							<dl>
								...
								<dd>
									<input type="text" name="subject" size="74" maxlength="100"
										class="form-control" placeholder="제목을 입력하세요" value="원래글의 수정전 제목" required="required">
								</dd>
							</dl>
						</div>
							...
							<dl>
								...
								<dd>
									<select name="searchCategory" class="form-control" required="required">
										...
										<option value="pm" selected="selected">기획자/PM</option>
						...
						<div id="bbsCreated_content" class="form-floating">
							<dl>
								<dt>내&nbsp;&nbsp;&nbsp;&nbsp;용</dt>
								<dd>
									<textarea class="form-control" placeholder="내용을 입력하세요" id="floatingTextarea" style="height: 170px;" required="required">
									원래 글의 수정전 내용
									</textarea>
							...
							<dl>
								...
								<dd>
									<input type="password" name="pwd" size="35" maxlength="10"
										class="form-control" placeholder="패스워드를 입력하세요"> &nbsp;<span style="font-size: 7pt;"></span>
								</dd>
							</dl>
						</div>
						<!-- #bbsCreated_noLine -->
						...
						<div id="bbsCreated_footer" class= "div">
							<input type="submit" value="게시물수정" class="btn btn-outline-primary"
								onclick="sendIt()"> 
							<input type="reset" value="전체삭제"
								class="btn btn-outline-primary" onclick="document.myForm.subject.focus()">
							<input type="button" value="수정취소" class="btn btn-outline-primary"
