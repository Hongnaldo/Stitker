...
<!-- Bootstrap CSS -->
    ...
    <title>Member_myInformation.jsp</title>
				...
				<div class="table">
					<center>
						...
						<form class="login" name="newMem" action="loginOk.jsp"
							method="post">
							<table cellspacing=10 style="width:100%;" class="table table-striped table-condensed table-hover">
								<tr>
									<td>아 이 디 :</td>
									<td><input type="text" name="id" hidden="">abcd</td>
								</tr>
