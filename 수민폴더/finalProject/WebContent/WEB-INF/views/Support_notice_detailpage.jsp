...
<script type="text/javascript">
	...
	function modify(notice_code) 
	{
		window.location.href="supportnoticemodifyf.action?notice_code="+notice_code;
	}
...
<div class="wrapper">
	...
	<div class="main-content"><br>
		...
		<div class="content">
			...
			<br>
			<div class="buttons">
				<button type="button" class="btn btn-outline-primary" onclick="modify('${detail.notice_code}')">수정하기</button>
