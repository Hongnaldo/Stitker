...
<head>
<meta charset="UTF-8">
<title>Support_notice_modify.jsp</title>
...
<div class="wrapper">
	...
	<div class="main-content"><br>
		...
		<div class="content">		
			...
			<br>
			<form action="supportnoticemodify.action" method="post" onsubmit="return modifyNotice()">
			<div class="tableDiv">
				<table class="table table-borderless">
					<tr>
						<th>제목</th>
						<td>
							<input type="text" class="form-control write" id="title" placeholder="제목을 입력하세요" name="notice_title" value="${dto.notice_title }" required>
						</td>
					</tr>
					<tr>
						<th>내용</th>
						<td class="textareaTd">
							<textarea name="notice_content" id="summernote" >${dto.notice_content }</textarea>
