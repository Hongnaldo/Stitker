...
EXEC PRC_MEM_RPT_REG_INSERT(SYSDATE-5, 'UC3', 'RC5', '몰래 화장실가서 대마초피우는걸 봤어요', 'UC5', 'SO10');
EXEC PRC_MEM_RPT_REG_INSERT(SYSDATE-3, 'UC6', 'RC4', '입에 걸레를 물었습니다.', 'UC5', 'SO10');

SELECT P.PARTI_CODE, A.USER_CODE, A.STUDY_CODE
FROM TBL_STUDY_PARTICIPANT P JOIN TBL_STUDY_APPLY A
  ON P.APPLY_CODE = A.APPLY_CODE
