...
EXEC PRG_INSERT_WARNING('UC7', SYSDATE+802);
...
, LOC_MC_CODE)
VALUES
( 'SO'||STD_OPEN_SEQ.NEXTVAL, 'UC3', SYSDATE, 'ST3', 'IM9', SYSDATE+10, SYSDATE+100, 'MN1', 'MN6', 'UR4', SYSDATE+8, '테스트', '신청취소테스트용', 'LM3');
COMMIT;
SELECT *
FROM USER_SEQUENCES;
...
INSERT INTO TBL_STUDY_APPLY(APPLY_CODE, STUDY_CODE, USER_CODE, APPLY_DATE, POSITION_CODE)
VALUES('SA'|| STUDY_APL_SEQ.NEXTVAL, 'SO9', 'UC4', SYSDATE, 'SP2');
...
EXEC PRC_INSERT_CANCEL( 'SA14', TO_DATE('2021-01-11', 'YYYY-MM-DD'), NULL);

DELETE FROM TBL_STUDY_CANCEL
WHERE CANCEL_CODE > 'SC23';
...
SET WRITE_DATE = SYSDATE-10, START_DATE = SYSDATE
WHERE STUDY_CODE = 'SO9';
