...
-- 추천/비추천 테이블 FK 삭제
ALTER TABLE TBL_REC_INFORM DROP CONSTRAINT REC_INFO_PC_FK;
ALTER TABLE TBL_REC_FREE DROP CONSTRAINT REC_FREE_PC_FK;
ALTER TABLE TBL_REC_INTERVIEW DROP CONSTRAINT REC_INTER_PC_FK;
ALTER TABLE TBL_REC_STUDYREVIEW DROP CONSTRAINT CMT_STRV_PC_FK;
ALTER TABLE TBL_REC_QUESTION DROP CONSTRAINT REC_QUE_PC_FK;
ALTER TABLE TBL_REC_ANSWER DROP CONSTRAINT REC_AWR_PC_FK;
ALTER TABLE TBL_REC_SEMINAR DROP CONSTRAINT REC_SEMI_PC_FK;

-- 추천/비추천 테이블 FK 추가(CASCADE 조건 추가)
ALTER TABLE TBL_REC_INFORM ADD CONSTRAINT REC_INFO_PC_FK
  FOREIGN KEY(POST_CODE)
  REFERENCES TBL_BOARD_INFORM(POST_CODE) ON DELETE CASCADE;
  
ALTER TABLE TBL_REC_SEMINAR ADD CONSTRAINT REC_SEMI_PC_FK
  FOREIGN KEY(POST_CODE)
  REFERENCES TBL_BOARD_SEMINAR(POST_CODE) ON DELETE CASCADE;
  
ALTER TABLE TBL_REC_STUDYREVIEW ADD CONSTRAINT REC_STRV_PC_FK
  FOREIGN KEY(POST_CODE)
  REFERENCES TBL_BOARD_STUDYREVIEW(POST_CODE) ON DELETE CASCADE;
  
ALTER TABLE TBL_REC_QUESTION ADD CONSTRAINT REC_QUE_PC_FK
  FOREIGN KEY(POST_CODE)
  REFERENCES TBL_BOARD_QUESTION(POST_CODE) ON DELETE CASCADE;

ALTER TABLE TBL_REC_ANSWER ADD CONSTRAINT REC_AWR_PC_FK
  FOREIGN KEY(POST_CODE)
  REFERENCES TBL_BOARD_ANSWER(POST_CODE) ON DELETE CASCADE;

ALTER TABLE TBL_REC_FREE ADD CONSTRAINT REC_FREE_PC_FK
  FOREIGN KEY(POST_CODE)
  REFERENCES TBL_BOARD_FREE(POST_CODE) ON DELETE CASCADE;
