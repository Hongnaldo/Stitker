...
ADD ( CONSTRAINT STD_MEETDAY_WDC_FK FOREIGN KEY(WEEKDAY_CODE)
     ...
     , CONSTRAINT STD_MEETDAY_SC_FK FOREIGN KEY(STUDY_CODE)
...
, CONSTRAINT RPT_HLE_STRV_HR_FK FOREIGN KEY(HANDLE_RESULT_CODE)
 ...
 -- 스터디 댓글 테이블
CREATE TABLE TBL_COMMENT_STUDY
( COMMENT_CODE  VARCHAR2(10)
, STUDY_CODE    VARCHAR2(15)                 NOT NULL
, COMMENTS      VARCHAR2(800)                NOT NULL
, USER_CODE     VARCHAR2(10)                 NOT NULL   
, WRITE_DATE    DATE         DEFAULT SYSDATE NOT NULL
, CONSTRAINT CMT_STD_CC_PK PRIMARY KEY (COMMENT_CODE)
, CONSTRAINT CMT_STD_SC_FK FOREIGN KEY (STUDY_CODE)
  REFERENCES TBL_STUDY_OPEN (STUDY_CODE)
, CONSTRAINT CMT_STD_UC_FK FOREIGN KEY (USER_CODE)
  REFERENCES TBL_USER_CODE_CREATE (USER_CODE)
);
