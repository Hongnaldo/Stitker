...
<div class="login">
	...
	<div class="login_input">
		<!-- 로그인 ID 입력 -->
		<input type="text" class="form-control" placeholder="아이디 입력" required="required" name="id">
		<p>입력한 아이디가 존재하지 않습니다. 아이디를 다시 한번 입력해 주세요.</p>
		
		
		<!-- 로그인 Password 입력 -->
		<input type="password" class="form-control" placeholder="비밀번호 입력" required="required" name="pw">
